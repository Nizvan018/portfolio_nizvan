        ...
        <>
            <form onSubmit={(e) => submit(e)} className="flex flex-col items-start gap-4">
                ...
                <button
                    onClick={submit}
                    type="button"
                    className="font-semibold py-3 px-6 rounded-lg bg-gradient-to-r from-pink-500/85 via-violet-500/85 to-sky-500/85 cursor-pointer duration-200 hover:opacity-80"
                >
                    Enviar mensaje
                </button>
